 ...
 */
 ...
 $theme: (
  ...
  card-color: #8c8a9e,
  circle-bg: #7b7a8b,
  bottom-card-text: #4d4964,
  light-text: #c4c1da,
  line-color: #62606e,
  upcoming-card-color: #5f5b7b,
  notes-header: #6c6984,

  notifications-bg: #49465a,
  page-bg: #6e6c7e,
  traders-hub-text: #4b4761,
  scrollbar-background: #4d4964,
  calendar-row-2: #8f8da0,
  light-text-2: #d7d5e2 ,
  notification-shadow: #7f7c93,
  notification-header: #4a4953,
  trader-chart-side: #62606e,
  shadow: 0 8px 20px 0 rgba(68, 67, 77, .6),
  scrollbar-circle: #4b4761,
  bg-color-tabset: #0dff92,
  shade-white-1: #fff,
  background-img: url(https://d308fakbqebk7c.cloudfront.net/theme_images/90.jpg),
  background-img-2: url(https://d308fakbqebk7c.cloudfront.net/theme_images/90.jpg),
 ...
 // register the theme
 $nb-themes: nb-register-theme($theme, Candy, default);
