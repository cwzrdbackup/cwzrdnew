 ...
 */
 ...
 $theme: (
  ...
  card-color: #505260,
  circle-bg: #3c3e48,
  bottom-card-text: #7a7d93,
  light-text: #c2c8ee,
  line-color: #34353f,
  upcoming-card-color: #9599b3,
  notes-header: #a0a2b2,

  notifications-bg: #23242a,
  page-bg: #353740,
  traders-hub-text: #76798e,
  scrollbar-background: #7a7d93,
  calendar-row-2: #565865,
  light-text-2: #d6d9eb,
  notification-shadow: #abadba,
  notification-header: #24252b,
  trader-chart-side: #383943,
  shadow: 0 8px 20px 0 rgba(39, 40, 47, .6),
  scrollbar-circle: #76798e,
  bg-color-tabset: #0dff92,
  shade-white-1: #fff,
  background-img: url(https://d308fakbqebk7c.cloudfront.net/theme_images/56.jpg),
  background-img-2: url(https://d308fakbqebk7c.cloudfront.net/theme_images/56.jpg),
 ...
 // register the theme
 $nb-themes: nb-register-theme($theme, Land_of_Promises, default);
