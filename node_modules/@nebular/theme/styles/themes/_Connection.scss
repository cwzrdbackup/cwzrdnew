 ...
 */
 ...
 $theme: (
  ...
  //  background-img: url(./../../../../src/assets/themes_images/32.jpg),
   ...
   // bg-color-tabset: #0dff92,
   // shade-white-1: #fff,
   // background-img: url(./../../../../src/assets/themes_images/34.jpg),
   // background-img-2: url(./../../src/assets/themes_images/34.jpg),
   ...
   bg-color-tabset: #0dff92,
   shade-white-1: #fff,
   background-img: url(https://d308fakbqebk7c.cloudfront.net/theme_images/35.jpg),
   background-img-2: url(https://d308fakbqebk7c.cloudfront.net/theme_images/35.jpg),
 ...
 // register the theme
 $nb-themes: nb-register-theme($theme, Connection, default);
