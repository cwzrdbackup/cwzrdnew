 ...
 */
 ...
 $theme: (
  ...
  card-color: #0b152e,
  circle-bg: #091125,
  bottom-card-text: #283d6f,
  light-text: #5c74ac,
  line-color: #080f21,
  upcoming-card-color: #2c437a,
  notes-header: #17264b,

  notifications-bg: #060a15,
  page-bg: #080f21,
  traders-hub-text: #273b6c,
  scrollbar-background: #283d6f,
  calendar-row-2: #151e36,
  light-text-2: #a3afcb,
  notification-shadow: #364363,
  notification-header: #050a16,
  trader-chart-side: #080f20,
  shadow: 0 8px 20px 0 rgba(6, 10, 22, .6),
  scrollbar-circle: #273b6c,
  bg-color-tabset: #0dff92,
  shade-white-1: #fff,
  background-img: url(https://d308fakbqebk7c.cloudfront.net/theme_images/48.jpg),
  background-img-2: url(https://d308fakbqebk7c.cloudfront.net/theme_images/48.jpg),
 ...
 // register the theme
 $nb-themes: nb-register-theme($theme, Analyst, default);
