...
$theme: (
  ...
  color-Cal-Title: #40ffa9,
  
  calendarRow: #58598e,
  
  color-fg-text-2: #3b367f,
  color-fg-text-3: #d1d1ff,
  color-fg-text-4: #c198fb,
  
  color-light-2: #d1d1ff,
  
  font-main: unquote('"Exo", "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif'),
