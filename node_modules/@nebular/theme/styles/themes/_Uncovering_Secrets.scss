 ...
 */
 ...
 $theme: (
  ...
  card-color: #191f2e,
  circle-bg: #151a27,
  bottom-card-text: #3b4c75,
  light-text: #758abe,
  line-color: #131824,
  upcoming-card-color: #4a5f93,
  notes-header: #44598e,

  notifications-bg: #0d0f17,
  page-bg: #131723,
  traders-hub-text: #394a71,
  scrollbar-background: #3b4c75,
  calendar-row-2: #222836,
  light-text-2: #afbad4,
  notification-shadow: #5d6e9c,
  notification-header: #0d1017,
  trader-chart-side: #111620,
  shadow: 0 8px 20px 0 rgba(12, 15, 22, .6),
  scrollbar-circle: #394a71,
  bg-color-tabset: #0dff92,
  shade-white-1: #fff,
  background-img: url(https://d308fakbqebk7c.cloudfront.net/theme_images/45.jpg),
  background-img-2: url(https://d308fakbqebk7c.cloudfront.net/theme_images/45.jpg),
 ...
 // register the theme
 $nb-themes: nb-register-theme($theme, Uncovering_Secrets, default);
