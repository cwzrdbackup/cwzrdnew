 ...
 */
 ...
 $theme: (
  ...
  card-color: #66a9cc,
  circle-bg: #5089a7,
  bottom-card-text: #5893b2,
  light-text: #c7ecff,
  line-color: #5490af,
  upcoming-card-color: #82d1fb,
  notes-header: #79c0e5,

  notifications-bg: #2f5782,
  page-bg: #477c9d,
  traders-hub-text: #558eac,
  scrollbar-background: #5893b2,
  calendar-row-2: #6babcc,
  light-text-2: #d8eaf4,
  notification-shadow: #8ac6e6,
  notification-header: #305264,
  trader-chart-side: #47768e,
  shadow: 0 8px 20px 0 rgba(50, 82, 99, .6),
  scrollbar-circle: #558eac,
  bg-color-tabset: #0dff92,
  shade-white-1: #fff,
  background-img: url(https://d308fakbqebk7c.cloudfront.net/theme_images/54.jpg),
  background-img-2: url(https://d308fakbqebk7c.cloudfront.net/theme_images/54.jpg),
 ...
 // register the theme
 $nb-themes: nb-register-theme($theme, Internal_Traces, default);
