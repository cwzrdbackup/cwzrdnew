 ...
 */
 ...
 $theme: (
  ...
  card-color: #423c5e,
  circle-bg: #393351,
  bottom-card-text: #655c8d,
  light-text: #aaa1d3,
  line-color: #3a3553,
  upcoming-card-color: #8c80c4,
  notes-header: #9188bb,

  notifications-bg: #221e2f,
  page-bg: #332d48,
  traders-hub-text: #625989,
  scrollbar-background: #655c8d,
  calendar-row-2: #494364,
  light-text-2: #cac5de,
  notification-shadow: #9e96c2,
  notification-header: #221f31,
  trader-chart-side: #2e2a42,
  shadow: 0 8px 20px 0 rgba(32, 29, 46, .6),
  scrollbar-circle: #625989,
  bg-color-tabset: #0dff92,
  shade-white-1: #fff,
  background-img: url(https://d308fakbqebk7c.cloudfront.net/theme_images/46.jpg),
  background-img-2: url(https://d308fakbqebk7c.cloudfront.net/theme_images/46.jpg),
 ...
 // register the theme
 $nb-themes: nb-register-theme($theme, United_Colours, default);
