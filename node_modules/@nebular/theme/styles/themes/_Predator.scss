 ...
 */
 ...
 $theme: (
  ...
  card-color: #3b3d42,
  circle-bg: #2f3135,
  bottom-card-text: #4c4d52,
  light-text: #9d9fa5,
  line-color: #2a2b2f,
  upcoming-card-color: #7d7f86,
  notes-header: #696a6e,

  notifications-bg: #1c1d1f,
  page-bg: #2a2c2f,
  traders-hub-text: #4a4b4f,
  scrollbar-background: #4c4d52,
  calendar-row-2: #424449,
  light-text-2: #c3c4c7 ,
  notification-shadow: #7c7d80,
  notification-header: #1c1d20,
  trader-chart-side: #292b2e,
  shadow: 0 8px 20px 0 rgba(29, 30, 32, .6),
  scrollbar-circle: #4a4b4f,
  bg-color-tabset: #0dff92,
  shade-white-1: #fff,
  background-img: url(https://d308fakbqebk7c.cloudfront.net/theme_images/82.jpg),
  background-img-2: url(https://d308fakbqebk7c.cloudfront.net/theme_images/82.jpg),
 ...
 // register the theme
 $nb-themes: nb-register-theme($theme, Predator, default);
