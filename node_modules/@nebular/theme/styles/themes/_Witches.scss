 ...
 */
 ...
 $theme: (
  ...
  card-color: #0e2c4c,
  circle-bg: #0c2642,
  bottom-card-text: #29588b,
  light-text: #7bb0ea,
  line-color: #0a2038,
  upcoming-card-color: #397ac0,
  notes-header: #2c65a2,

  notifications-bg: #071626,
  page-bg: #0b223b,
  traders-hub-text: #285587,
  scrollbar-background: #29588b,
  calendar-row-2: #183452,
  light-text-2: #b2cde9 ,
  notification-shadow: #4879ad,
  notification-header: #071728,
  trader-chart-side: #0a1f35,
  shadow: 0 8px 20px 0 rgba(7, 22, 37, .6),
  scrollbar-circle: #285587,
  bg-color-tabset: #0dff92,
  shade-white-1: #fff,
  background-img: url(https://d308fakbqebk7c.cloudfront.net/theme_images/85.jpg),
  background-img-2: url(https://d308fakbqebk7c.cloudfront.net/theme_images/85.jpg),
 ...
 // register the theme
 $nb-themes: nb-register-theme($theme, Witches, default);
