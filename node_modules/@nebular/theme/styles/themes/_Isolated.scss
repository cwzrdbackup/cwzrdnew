 ...
 */
 ...
 $theme: (
  ...
  card-color: #0d2639,
  circle-bg: #081b29,
  bottom-card-text: #134a74,
  light-text: #388dce,
  line-color: #091e2d,
  upcoming-card-color: #195989,
  notes-header: #1a4769,

  notifications-bg: #051018,
  page-bg: #071824,
  traders-hub-text: #124870,
  scrollbar-background: #134a74,
  calendar-row-2: #172e40,
  light-text-2: #91bbdc,
  notification-shadow: #395f7c,
  notification-header: #051019,
  trader-chart-side: #091b28,
  shadow: 0 8px 20px 0 rgba(6, 19, 28, .6),
  scrollbar-circle: #124870,
  bg-color-tabset: #0dff92,
  shade-white-1: #fff,
  background-img: url(https://d308fakbqebk7c.cloudfront.net/theme_images/55.jpg),
  background-img-2: url(https://d308fakbqebk7c.cloudfront.net/theme_images/55.jpg),
 ...
 // register the theme
 $nb-themes: nb-register-theme($theme, Isolated, default);
