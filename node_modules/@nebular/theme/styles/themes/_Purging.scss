 ...
 */
 ...
 $theme: (
  ...
  card-color: #222224,
  circle-bg: #1b1b1d,
  bottom-card-text: #535355,
  light-text: #acacb0,
  line-color: #1b1b1d,
  upcoming-card-color: #747477,
  notes-header: #4a4a4d,

  notifications-bg: #101011,
  page-bg: #18181a,
  traders-hub-text: #505052,
  scrollbar-background: #535355,
  calendar-row-2: #2b2b2c,
  light-text-2: #cbcbcd ,
  notification-shadow: #626264,
  notification-header: #101011,
  trader-chart-side: #181819,
  shadow: 0 8px 20px 0 rgba(17, 17, 17, .6),
  scrollbar-circle: #505052,
  bg-color-tabset: #0dff92,
  shade-white-1: #fff,
   background-img: url(https://d308fakbqebk7c.cloudfront.net/theme_images/81.jpg),
   background-img-2: url(https://d308fakbqebk7c.cloudfront.net/theme_images/81.jpg),
 ...
 // register the theme
 $nb-themes: nb-register-theme($theme, Purging, default);
