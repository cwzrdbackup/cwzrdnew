 ...
 */
 ...
 $theme: (
  ...
  card-color: #16403c,
  circle-bg: #0e2d2a,
  bottom-card-text: #205d57,
  light-text: #43b3a8,
  line-color: #0f2f2c,
  upcoming-card-color: #2b7d75,
  notes-header: #2f615c,

  notifications-bg: #081a18,
  page-bg: #0c2825,
  traders-hub-text: #1f5a54,
  scrollbar-background: #205d57,
  calendar-row-2: #1f4743,
  light-text-2: #96cec9 ,
  notification-shadow: #4b7571,
  notification-header: #081b19,
  trader-chart-side: #0f2d2a,
  shadow: 0 8px 20px 0 rgba(10, 31, 29, .6),
  scrollbar-circle: #1f5a54,
  bg-color-tabset: #0dff92,
  shade-white-1: #fff,
  background-img: url(https://d308fakbqebk7c.cloudfront.net/theme_images/91.jpg),
  background-img-2: url(https://d308fakbqebk7c.cloudfront.net/theme_images/91.jpg),
 ...
 // register the theme
 $nb-themes: nb-register-theme($theme, Mother_Nature, default);
