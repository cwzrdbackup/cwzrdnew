 ...
 */
 ...
 $theme: (
  ...
  card-color: #121212,
  circle-bg: #0b0b0b,
  bottom-card-text: #292929,
  light-text: #a2a2a2,
  line-color: #000000,
  upcoming-card-color: #454444,
  notes-header: #484747,

  notifications-bg: #070606,
  page-bg: #0a0a0a,
  traders-hub-text: #282828,
  scrollbar-background: #292929,
  calendar-row-2: #1b1b1b,
  light-text-2: #c6c6c6,
  notification-shadow: #605f5f,
  notification-header: #070707,
  trader-chart-side: #0d0d0d,
  shadow: 0 8px 20px 0 rgba(9, 9, 9, .6),
  scrollbar-circle: #282828,
  bg-color-tabset: #0dff92,
  shade-white-1: #fff,
  background-img: url(https://d308fakbqebk7c.cloudfront.net/theme_images/42.jpg),
  background-img-2: url(https://d308fakbqebk7c.cloudfront.net/theme_images/42.jpg),
 ...
 // register the theme
 $nb-themes: nb-register-theme($theme, Infinity, default);
