 ...
 */
 ...
 $theme: (
  ...
  card-color: #202020,
  circle-bg: #1a1a1a,
  bottom-card-text: #4b4949,
  light-text: #9e9b9b,
  line-color: #171717,
  upcoming-card-color: #686565,
  notes-header: #515151,

  notifications-bg: #0f0f0f,
  page-bg: #171717,
  traders-hub-text: #494747,
  scrollbar-background: #4b4949,
  calendar-row-2: #292929,
  light-text-2: #c4c2c2,
  notification-shadow: #686868,
  notification-header: #101010,
  trader-chart-side: #161616,
  shadow: 0 8px 20px 0 rgba(15, 15, 15, .6),
  scrollbar-circle: #494747,
  bg-color-tabset: #0dff92,
  shade-white-1: #fff,
  background-img: url(https://d308fakbqebk7c.cloudfront.net/theme_images/71.jpg),
  background-img-2: url(https://d308fakbqebk7c.cloudfront.net/theme_images/71.jpg),
 ...
 // register the theme
 $nb-themes: nb-register-theme($theme, Ghost_Town, default);
