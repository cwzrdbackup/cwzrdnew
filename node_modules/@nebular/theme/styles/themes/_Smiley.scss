 ...
 */
 ...
 $theme: (
  ...
  card-color: #1c1b1b,
  circle-bg: #434040,
  bottom-card-text: #d8b855,
  light-text: #dfd689,
  line-color: #3d3e3d,
  upcoming-card-color: #ffcf3f,
  notes-header: #403f3f,

  notifications-bg: #282525,
  page-bg: #3c3939,
  traders-hub-text: #d1b252,
  scrollbar-background: #d8b855,
  calendar-row-2: #252424,
  light-text-2: #e4e0b9,
  notification-shadow: #595858,
  notification-header: #282626,
  trader-chart-side: #141313,
  shadow: 0 8px 20px 0 rgba(14, 13, 13, .6),
  scrollbar-circle: #d1b252,
  bg-color-tabset: #0dff92,
  shade-white-1: #fff,
  background-img: url(https://d308fakbqebk7c.cloudfront.net/theme_images/53.jpg),
  background-img-2: url(https://d308fakbqebk7c.cloudfront.net/theme_images/53.jpg),
 ...
 // register the theme
 $nb-themes: nb-register-theme($theme, Smiley, default);
