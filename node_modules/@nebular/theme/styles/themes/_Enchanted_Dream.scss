 ...
 */
 ...
 $theme: (
  ...
  card-color: #4c4957,
  circle-bg: #45424f,
  bottom-card-text: #64626d,
  light-text: #b9b7c4,
  line-color: #423f4b,
  upcoming-card-color: #928f9f,
  notes-header: #64626f,

  notifications-bg: #29262d,
  page-bg: #3e3b46,
  traders-hub-text: #615f6a,
  scrollbar-background: #64626d,
  calendar-row-2: #52505d,
  light-text-2: #d1d0d7,
  notification-shadow: #787681,
  notification-header: #29282f,
  trader-chart-side: #35333d,
  shadow: 0 8px 20px 0 rgba(37, 36, 43, .6),
  scrollbar-circle: #615f6a,
  bg-color-tabset: #0dff92,
  shade-white-1: #fff,
  background-img: url(https://d308fakbqebk7c.cloudfront.net/theme_images/41.jpg),
  background-img-2: url(https://d308fakbqebk7c.cloudfront.net/theme_images/41.jpg),
 ...
 // register the theme
 $nb-themes: nb-register-theme($theme, Enchanted_Dream, default);
