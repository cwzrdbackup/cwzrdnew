 ...
 */
 ...
 $theme: (
  ...
  card-color: #276e6e,
  circle-bg: #1d5454,
  bottom-card-text: #36a6a6,
  light-text: #53a8a8,
  line-color: #194747,
  upcoming-card-color: #3fbaba,
  notes-header: #3a8484,

  notifications-bg: #123131,
  page-bg: #1a4b4b,
  traders-hub-text: #34a1a1,
  scrollbar-background: #36a6a6,
  calendar-row-2: #2f7373,
  light-text-2: #9ec9c9,
  notification-shadow: #549393,
  notification-header: #113232,
  trader-chart-side: #1b4d4d,
  shadow: 0 8px 20px 0 rgba(19, 54, 54, .6),
  scrollbar-circle: #34a1a1,
  bg-color-tabset: #0dff92,
  shade-white-1: #fff,
  background-img: url(https://d308fakbqebk7c.cloudfront.net/theme_images/43.jpg),
  background-img-2: url(https://d308fakbqebk7c.cloudfront.net/theme_images/43.jpg),
 ...
 // register the theme
 $nb-themes: nb-register-theme($theme, Pirate, default);
