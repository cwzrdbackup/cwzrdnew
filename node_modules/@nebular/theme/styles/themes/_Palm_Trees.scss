 ...
 */
 ...
 $theme: (
  ...
  card-color: #275659,
  circle-bg: #21494c,
  bottom-card-text: #3e7e82,
  light-text: #8acfd3,
  line-color: #21484b,
  upcoming-card-color: #54aaaf,
  notes-header: #438f93,

  notifications-bg: #142a2c,
  page-bg: #1d4143,
  traders-hub-text: #3c7a7e,
  scrollbar-background: #3e7e82,
  calendar-row-2: #2f5c5f,
  light-text-2: #badcde,
  notification-shadow: #5c9ca0,
  notification-header: #142c2e,
  trader-chart-side: #1b3c3e,
  shadow: 0 8px 20px 0 rgba(19, 42, 43, .6),
  scrollbar-circle: #3c7a7e,
  bg-color-tabset: #0dff92,
  shade-white-1: #fff,
  background-img: url(https://d308fakbqebk7c.cloudfront.net/theme_images/47.jpg),
  background-img-2: url(https://d308fakbqebk7c.cloudfront.net/theme_images/47.jpg),
 ...
 // register the theme
 $nb-themes: nb-register-theme($theme, Palm_Trees, default);
