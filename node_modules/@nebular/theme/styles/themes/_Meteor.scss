 ...
 */
 ...
 $theme: (
  ...
  card-color: #091b33,
  circle-bg: #05101f,
  bottom-card-text: #2c638b,
  light-text: #3a7ace,
  line-color: #061325,
  upcoming-card-color: #3f88bc,
  notes-header: #1a375d,

  notifications-bg: #030912,
  page-bg: #050e1b,
  traders-hub-text: #2b6087,
  scrollbar-background: #2c638b,
  calendar-row-2: #13243b,
  light-text-2: #92b2dc,
  notification-shadow: #395272,
  notification-header: #030a13,
  trader-chart-side: #061324,
  shadow: 0 8px 20px 0 rgba(4, 13, 25, .6),
  scrollbar-circle: #2b6087,
  bg-color-tabset: #0dff92,
  shade-white-1: #fff,
  background-img: url(https://d308fakbqebk7c.cloudfront.net/theme_images/73.jpg),
  background-img-2: url(https://d308fakbqebk7c.cloudfront.net/theme_images/73.jpg),
 ...
 // register the theme
 $nb-themes: nb-register-theme($theme, Meteor, default);
