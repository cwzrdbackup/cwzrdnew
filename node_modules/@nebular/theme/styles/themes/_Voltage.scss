 ...
 */
 ...
 $theme: (
  ...
  card-color: #1e202d,
  circle-bg: #191b26,
  bottom-card-text: #4a4d5d,
  light-text: #9295a2,
  line-color: #191a25,
  upcoming-card-color: #5d6175,
  notes-header: #383b4a,

  notifications-bg: #0f1016,
  page-bg: #161822,
  traders-hub-text: #484b5a,
  scrollbar-background: #4a4d5d,
  calendar-row-2: #272935,
  light-text-2: #bebfc6,
  notification-shadow: #525562,
  notification-header: #0f1017,
  trader-chart-side: #15161f,
  shadow: 0 8px 20px 0 rgba(15, 15, 22, .6),
  scrollbar-circle: #484b5a,
  bg-color-tabset: #0dff92,
  shade-white-1: #fff, 
  background-img: url(https://d308fakbqebk7c.cloudfront.net/theme_images/49.jpg),
  background-img-2: url(https://d308fakbqebk7c.cloudfront.net/theme_images/49.jpg),
 ...
 // register the theme
 $nb-themes: nb-register-theme($theme, Voltage, default);
