 ...
 */
 ...
 $theme: (
  ...
  card-color: #385468,
  circle-bg: #30495a,
  bottom-card-text: #5a7282,
  light-text: #97bad1,
  line-color: #2c4252,
  upcoming-card-color: #85a9c1,
  notes-header: #799cb4,

  notifications-bg: #1c2a34,
  page-bg: #2b4150,
  traders-hub-text: #576e7e,
  scrollbar-background: #5a7282,
  calendar-row-2: #3f5a6d,
  light-text-2: #c0d2dd,
  notification-shadow: #8aa7bc,
  notification-header: #1d2c36,
  trader-chart-side: #273b49,
  shadow: 0 8px 20px 0 rgba(27, 41, 51, .6),
  scrollbar-circle: #576e7e,
  bg-color-tabset: #0dff92,
  shade-white-1: #fff,
  background-img: url(https://d308fakbqebk7c.cloudfront.net/theme_images/64.jpg),
  background-img-2: url(https://d308fakbqebk7c.cloudfront.net/theme_images/64.jpg),
 ...
 // register the theme
 $nb-themes: nb-register-theme($theme, Towers_of_Wizardry, default);
