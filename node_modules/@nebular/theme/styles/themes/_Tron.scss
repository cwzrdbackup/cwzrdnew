 ...
 */
 ...
 $theme: (
  ...
  card-color: #171717,
  circle-bg: #363636,
  bottom-card-text: #43b5c8,
  light-text: #62adbc,
  line-color: #2f2f2f,
  upcoming-card-color: #61d6ea,
  notes-header: #484747,

  notifications-bg: #201f1f,
  page-bg: #303030,
  traders-hub-text: #41afc2,
  scrollbar-background: #43b5c8,
  calendar-row-2: #202020,
  light-text-2: #a6cbd3,
  notification-shadow: #605f5f,
  notification-header: #202020,
  trader-chart-side: #101010,
  shadow: 0 8px 20px 0 rgba(11, 11, 11, .6),
  scrollbar-circle: #41afc2,
  bg-color-tabset: #0dff92,
  shade-white-1: #fff,
  background-img: url(https://d308fakbqebk7c.cloudfront.net/theme_images/44.jpg),
  background-img-2: url(https://d308fakbqebk7c.cloudfront.net/theme_images/44.jpg),
 ...
 // register the theme
 $nb-themes: nb-register-theme($theme, Tron, default);
