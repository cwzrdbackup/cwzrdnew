 ...
 */
 ...
 $theme: (
  ...
  card-color: #2d204d,
  circle-bg: #281c44,
  bottom-card-text: #68549c,
  light-text: #ab93e9,
  line-color: #261b41,
  upcoming-card-color: #8b71cf,
  notes-header: #8872c1,

  notifications-bg: #181127,
  page-bg: #24193c,
  traders-hub-text: #655197,
  scrollbar-background: #68549c,
  calendar-row-2: #352953,
  light-text-2: #cabee9,
  notification-shadow: #9684c7,
  notification-header: #181129,
  trader-chart-side: #1f1636,
  shadow: 0 8px 20px 0 rgba(22, 15, 38, .6),
  scrollbar-circle: #655197,
  bg-color-tabset: #0dff92,
  shade-white-1: #fff,
  background-img: url(https://d308fakbqebk7c.cloudfront.net/theme_images/69.jpg),
  background-img-2: url(https://d308fakbqebk7c.cloudfront.net/theme_images/69.jpg),
 ...
 // register the theme
 $nb-themes: nb-register-theme($theme, Planets, default);
