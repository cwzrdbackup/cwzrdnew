 ...
 */
 ...
 $theme: (
  ...
  card-color: #2a1b2a,
  circle-bg: #201420,
  bottom-card-text: #704270,
  light-text: #a269a2,
  line-color: #1d131d,
  upcoming-card-color: #975b97,
  notes-header: #5f445f,

  notifications-bg: #130c13,
  page-bg: #1c121c,
  traders-hub-text: #6c406c,
  scrollbar-background: #704270,
  calendar-row-2: #322432,
  light-text-2: #c6a9c6 ,
  notification-shadow: #745d74,
  notification-header: #130c13,
  trader-chart-side: #1d131d,
  shadow: 0 8px 20px 0 rgba(20, 13, 20, .6),
  scrollbar-circle: #6c406c,
  bg-color-tabset: #0dff92,
  shade-white-1: #fff,
  background-img: url(https://d308fakbqebk7c.cloudfront.net/theme_images/92.jpg),
  background-img-2: url(https://d308fakbqebk7c.cloudfront.net/theme_images/92.jpg),
 ...
 // register the theme
 $nb-themes: nb-register-theme($theme, Mystic, default);
