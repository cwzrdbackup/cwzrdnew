 ...
 */
 ...
 $theme: (
  ...
  card-color: #616161,
  circle-bg: #515151,
  bottom-card-text: #737373,
  light-text: #d2d1d1,
  line-color: #4c4b4b,
  upcoming-card-color: #bababa,
  notes-header: #b0b0b0,

  notifications-bg: #302f2f,
  page-bg: #484848,
  traders-hub-text: #6f6f6f,
  scrollbar-background: #737373,
  calendar-row-2: #666666,
  light-text-2: #dedddd,
  notification-shadow: #b8b8b8,
  notification-header: #313131,
  trader-chart-side: #444444,
  shadow: 0 8px 20px 0 rgba(47, 47, 47, .6),
  scrollbar-circle: #6f6f6f,
  bg-color-tabset: #0dff92,
  shade-white-1: #fff,
  background-img: url(https://d308fakbqebk7c.cloudfront.net/theme_images/52.jpg),
  background-img-2: url(https://d308fakbqebk7c.cloudfront.net/theme_images/52.jpg),
 ...
 // register the theme
 $nb-themes: nb-register-theme($theme, Overload, default);
