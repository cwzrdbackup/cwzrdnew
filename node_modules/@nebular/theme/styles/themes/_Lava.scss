 ...
 */
 ...
 $theme: (
  ...
  card-color: #2c1e32,
  circle-bg: #25192a,
  bottom-card-text: #5f416c,
  light-text: #bb8fce,
  line-color: #211625,
  upcoming-card-color: #9a6dae,
  notes-header: #765883,

  notifications-bg: #160e18,
  page-bg: #211625,
  traders-hub-text: #5c3f69,
  scrollbar-background: #5f416c,
  calendar-row-2: #34273a,
  light-text-2: #d2bcdc ,
  notification-shadow: #876e92,
  notification-header: #160f19,
  trader-chart-side: #1f1523,
  shadow: 0 8px 20px 0 rgba(22, 15, 24, .6),
  scrollbar-circle: #5c3f69,
  bg-color-tabset: #0dff92,
  shade-white-1: #fff,
  background-img: url(https://d308fakbqebk7c.cloudfront.net/theme_images/83.jpg),
  background-img-2: url(https://d308fakbqebk7c.cloudfront.net/theme_images/83.jpg),
 ...
 // register the theme
 $nb-themes: nb-register-theme($theme, Lava, default);
