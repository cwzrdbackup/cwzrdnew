 ...
 */
 ...
 $theme: (
  ...
  card-color: #0b2039,
  circle-bg: #0a1c31,
  bottom-card-text: #396291,
  light-text: #77aeee,
  line-color: #091a2e,
  upcoming-card-color: #5288c8,
  notes-header: #3769a4,

  notifications-bg: #06111d,
  page-bg: #09192c,
  traders-hub-text: #375f8c,
  scrollbar-background: #396291,
  calendar-row-2: #152940,
  light-text-2: #b0cceb,
  notification-shadow: #527cae,
  notification-header: #06111d,
  trader-chart-side: #081628,
  shadow: 0 8px 20px 0 rgba(6, 15, 28, .6),
  scrollbar-circle: #375f8c,
  bg-color-tabset: #0dff92,
  shade-white-1: #fff,
  background-img: url(https://d308fakbqebk7c.cloudfront.net/theme_images/70.jpg),
  background-img-2: url(https://d308fakbqebk7c.cloudfront.net/theme_images/70.jpg),
 ...
 // register the theme
 $nb-themes: nb-register-theme($theme, Bloodline, default);
