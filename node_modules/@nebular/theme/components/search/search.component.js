...
var NbSearchComponent = /** @class */ (function () {
    ...
    NbSearchComponent = __decorate([
        Component({
            selector: 'nb-search',
            changeDetection: ChangeDetectionStrategy.OnPush,
            styles: [":host button{display: flex;align-items: center;color:#fff;font-weight: 700;margin:0 auto;padding:0;cursor:pointer;border:none;background:none}:host button:focus{box-shadow:none;outline:none}/deep/ nb-layout.with-search .scrollable-container{position:relative;z-index:0} "],
            template: "\n    <button #searchButton class=\"start-search\" (click)=\"emitActivate()\">\n      <i class=\"nb-search\" style=\"margin-right: 8px\"></i>\n    <span style=\"line-height: .95;\" class=\"search-text\">SEARCH</span></button>\n    <nb-search-field\n      *nbPortal\n      [show]=\"showSearchField\"\n      [type]=\"type\"\n      [placeholder]=\"placeholder\"\n      [hint]=\"hint\"\n      (search)=\"search($event)\"\n      (searchInput)=\"emitInput($event)\"\n      (close)=\"emitDeactivate()\">\n    </nb-search-field>\n  ",
        }),
