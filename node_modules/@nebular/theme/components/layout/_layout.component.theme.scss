...
@mixin nb-layout-theme() {
  ...
  nb-layout {
    @include nb-scrollbars(
        nb-theme(scrollbar-circle),
        nb-theme(scrollbar-background),
  ...
  nb-layout .layout {
    ...
    background: nb-theme(page-bg);
	//background-image: linear-gradient(to right, #7e80a3, #333c65);
