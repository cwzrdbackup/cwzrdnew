(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ngx-device-detector', ['exports', '@angular/core', '@angular/common'], factory) :
    (global = global || self, factory(global['ngx-device-detector'] = {}, global.ng.core, global.ng.common));
    ...
    ***************************************************************************** */
    ...
    var DEVICES_RE = __assign({}, MOBILES_RE, TABLETS_RE, { FIREFOX_OS: { and: [/\bFirefox\b/, /\bMobile\b/] }, CHROME_BOOK: /\bCrOS\b/, PS4: /\bMozilla\/5.0 \(PlayStation 4\b/, CHROMECAST: /\bCrKey\b/, APPLE_TV: /^iTunes-AppleTV\/4.1$/, GOOGLE_TV: /\bGoogleTV\b/ });
    ...
    var DeviceDetectorService = /** @class */ (function () {
                ...
                _this[mapping.prop] = Object.keys(Constants[mapping.const]).reduce(function (obj, item) {
                    if (Constants[mapping.const][item] === 'device') { // hack for iOS 13 Tablet
                        if (common.isPlatformBrowser(_this.platformId) &&
                            (!!_this.reTree.test(_this.userAgent, TABLETS_RE['iPad']) ||
        ...
        DeviceDetectorService.prototype.isMobile = function (userAgent) {
            ...
            var match = Object.keys(MOBILES_RE).find(function (mobile) {
                return _this.reTree.test(userAgent, MOBILES_RE[mobile]);
            });
            return !!match;
        };
        /**
        ...
        DeviceDetectorService.prototype.isTablet = function (userAgent) {
            ...
            var match = Object.keys(TABLETS_RE).find(function (mobile) {
                return !!_this.reTree.test(userAgent, TABLETS_RE[mobile]);
            });
            return !!match;
        };
        /**
    ...
    exports.MOBILES_RE = MOBILES_RE;
    exports.OS = OS;
    exports.OS_RE = OS_RE;
    exports.OS_VERSIONS = OS_VERSIONS;
    exports.OS_VERSIONS_RE = OS_VERSIONS_RE;
    exports.OS_VERSIONS_RE_MAP = OS_VERSIONS_RE_MAP;
    exports.ReTree = ReTree;
    exports.TABLETS_RE = TABLETS_RE;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=ngx-device-detector.umd.js.map
