    ...
    this.dataOptions2={
      dataset: {
        source: [
          ...
          [supp.volume*parseFloat(this.selectedPrice), '24 Hour Volume'],
          [supp.supply, 'Circulating Supply'],
          [supp.TotalCoinSupply, 'Max Supply'],
        ]
      },
      xAxis: {
        max: Math.max.apply(null, [supp.value,supp.volume,supp.supply,supp.TotalCoinSupply]),
      }
    }
