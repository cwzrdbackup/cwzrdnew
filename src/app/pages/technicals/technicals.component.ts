...
export class technicalsComponent implements OnInit {
  ...
  technicalsData: any[] = [
    { title: 'Cryptocurrency Articles', img: 'https://d308fakbqebk7c.cloudfront.net/crypto-card.png', router: "/technicals/cryptocurrency"},
    { title: 'Forex Articles', img: 'https://d308fakbqebk7c.cloudfront.net/forex-card.png', router: "/technicals/forex"},
  ]
  ...
  ngOnInit() {
    ...
    this._dataservice
      .postCall<any>(this._configuration.GetTechnicalsListApi, { pageNo: 1 })
      .subscribe(
        resp => {
