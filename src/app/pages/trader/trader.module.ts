...
import { NbLayoutModule, NbCardModule, NbSelectModule, NbTabsetModule, NbActionsModule,NbSpinnerModule } from '@nebular/theme';
...
@NgModule({
  declarations: [TraderComponent, Chart1Component, Chart2Component, Chart3Component, Table1Component, Chart4Component, Chart5Component, Chart6Component, Table2Component, Chart7Component, ochart1Component, ochart2Component, ochart4Component, ochart5Component, ochart6Component, ochart7Component, Chart8Component, Chart9Component, Chart2Componentm, ochart10Component, Chart1Componentm, Chart3Componentm, Chart10Component, flipchart2mComponentm, flipchart3mComponentm, Chart4Componentnew, ochart1newComponentnew],
  imports: [
    CommonModule,
  ...
  providers:[HubService,TraderService]
})
