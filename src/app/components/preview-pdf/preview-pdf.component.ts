...
export class PreviewPdfComponent implements OnInit {
  ...
  constructor(private _dataservice: ApiService, protected ref: NbDialogRef<PreviewPdfComponent>, public sanitizer: DomSanitizer, private http: HttpClient,
  ...
  retrievePdf(url) {
    this._dataservice.getDocument(url)
